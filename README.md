...
- 어차피 제 프로필 웹사이트가 필요했고.... 하하하
- 이 프로젝트를 가져가서 업그레이드 하실 개발자분들은 꼭 연락주세요(맵 데이터 깨집니다. 드려야해서 그래요 ㅠㅠ)
- **제발 회원가입시 실제 사용하는 이메일 사용하지말고 대충 아무거나 패스워드도 똑같이 꼭!!!**
...
> 3. 원하는 내용이나 망고단분들이 불편해서 자동화하고 모든 프로젝트를 여기에 포함시켜서 원하는 프로그램들을 여기서 다 편히 볼 수 있게 하는걸 목표로 하고 있음
> 4. 회원가입은 여러분들이 메모한 기능 그리고 공부했던 내역들을 저장하려고 만듦 (그래야 편하게 또 보고 수정할거니까~ )
...
> 1. 기준금리, 2. 국가 채무, 3. 군사력 순위, 4. 핵심산업, 5. 기술력
>
...
<p align="center">
  <img src="./public/tutorial/image.png" alt="상단 버튼 설명" width="400" />
</p>
...
<p align="center">
  <img src="./public/tutorial/image1.png" alt="자본흐름 편집" width="400" />
  <img src="./public/tutorial/image2.png" alt="관계선 편집" width="400" />
</p>
...
| 세계경제 과제 | ✅ | 지금 베타로 완료되었으나 필요한 기능들이 있다면 언제든지 연락주세요 |
| 비밀지도 과제 | ✅ | 모바일대응까지 완료 |
| dashboard 지표 | ✅ | dashboard에 우리 아이폰에 배포되었던 데이터들은 가져올 수 있게 만들어놓음 |
| 라자냐 과제 | ✅ | 아직 beta 그러나 backend 연결 완료 삭제가 안되고 지우기는 가능 및 추가 내용은 필요하면 업데이트 예정 |
