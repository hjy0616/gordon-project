export type EmailVerificationCodeEmailArgs = {
  to: string;
  name: string | null;
  code: string;
};

export function buildEmailVerificationCodeEmailHtml(
  args: EmailVerificationCodeEmailArgs
): string {
  return `<!DOCTYPE html>
<html lang="ko">
<head>
